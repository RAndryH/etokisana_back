...
export const EMAIL_TEMPLATE_PATH = path.join( __dirname, '../../../src/Utils/Emails/Template') // koyed path: /workspace/built/Utils/Emails/Template Local path: ../../Utils/Emails/Template